...
void simulatecsms(int students, int tutors, int chairs, int helplimit)
{
    ...
    struct student_thread_params st_params = {swb, chair_occupied, chair_available, helplimit, &st_countex_mutex, &st_threads_left};
    struct coordinator_thread_params ct_params = {chair_occupied, chair_available, waiting_for_tutor, tutor_available, &st_countex_mutex, &st_threads_left};
    struct tutor_thread_params tt_params = {swb, waiting_for_tutor, tutor_available, &st_countex_mutex, &st_threads_left};
